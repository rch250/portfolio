...
<body>
  <div id="wrapper">
    ...
    <main>
      ...
      <h1>Downtown Tour</h1>
        <img class="image" src="<?php echo BASE_URL; ?>images/downtowntoursmall.png" alt="Portland Downtown Tour" width="200" height="200">
        ...
        <br class="clearright">
      <h1>Growth Tour</h1>
        <img class="image" src="<?php echo BASE_URL; ?>images/growthtoursmall.png" alt="Reserve Growth Tour" width="200" height="200">
      ...
      <h1>Landmarks Tour</h1>
        <img class="image" src="<?php echo BASE_URL; ?>images/landmarkstoursmall.png" alt="Portland Landmarks Tour" width="200" height="200">
